...
const Analysis = (props) => {
	...
	return (
		<div style={{ display: "flex", flex: 1, flexDirection: "column", height: "100%", justifyContent: "center" }}>
			{
				state.loading
					? <Spin size="large" />
					: <>
						<div style={{ flex: 40, backgroundColor: "white", marginBottom: 15, borderRadius: 25 }}>
							<div style={{ display: "flex", flexDirection: "row", margin: 15, paddingLeft: 20, paddingRight: 30 }}>
